...
module.exports = {
    async up(queryInterface, Sequelize) {
        await queryInterface.bulkInsert('Botoes', [
            ...
            { id: 22, nome: 'Fechar/Abrir a porta', mensagem: 'Preciso ajuda para fechar/abrir a porta', imagem: '/imagesBotoes/necesidades/abrir_fechar_a_porta.png', categoria: 'Necessidades', createdAt: new Date(), updatedAt: new Date() },
            { id: 23, nome: 'Cocó', mensagem: 'Necessidades Fisiológicas: Cocó', imagem: '/imagesBotoes/necesidades/coco.png', categoria: 'Necessidades', createdAt: new Date(), updatedAt: new Date() },
            { id: 24, nome: 'Xixi', mensagem: 'Necessidades Fisiológicas: Xixi', imagem: '/imagesBotoes/necesidades/urina.png', categoria: 'Necessidades', createdAt: new Date(), updatedAt: new Date() },
